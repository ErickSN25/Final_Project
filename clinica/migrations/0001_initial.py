    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status_pagamento', models.CharField(choices=[('PENDENTE', 'Pendente de Pagamento'), ('AGUARDANDO_VALOR', 'Aguardando Definição de Valor'), ('AGUARDANDO_PAGAMENTO', 'Aguardando Pagamento do Cliente'), ('EM_ANALISE', 'Comprovante em Análise'), ('APROVADO', 'Pagamento Aprovado/Concluído'), ('RECUSADO', 'Pagamento Recusado')], default='PENDENTE', max_length=25, verbose_name='Status do Pagamento')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('atendente', models.ForeignKey(blank=True, limit_choices_to={'user_type': 'atendente'}, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
                ('consulta', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='gerenciamento_pagamento', to='clinica.consulta')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(limit_choices_to={'disponivel': True}, on_delete=django.db.models.deletion.PROTECT, to='clinica.horariodisponivel', verbose_name='Horário Agendado'),
        ),
        migrations.CreateModel(
            name='Notificacao',
            fields=[
                ...
                ('consulta_afetada', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='clinica.consulta')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consulta', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pagamentos_cliente', to='clinica.consulta')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='consulta',
            name='pet',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='clinica.pet'),
        ),
        migrations.CreateModel(
            name='Prontuario',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consulta', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='valor_pagamento', to='clinica.consulta')),
            ],
            options={
